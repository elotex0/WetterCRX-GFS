...
def fetch_geo(fh):
    ...
    out = f"data/geo/geo_{fh_padded}.grib2"
...
with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
    for fh in forecast_hours:
        tasks.append(executor.submit(fetch_geo, fh))
